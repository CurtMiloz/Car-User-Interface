...
namespace CarInterface
{
    ...
    public sealed partial class SettingsPage : Page
    {
        ...
        private void btCarSettings_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(CarAboutPage));

        }

        private void btMusic_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(MusicSettingPage));
